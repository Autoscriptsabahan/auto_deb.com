...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Autoscriptsabahan/auto_deb.com/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Apache07</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Autoscriptsabahan/auto_deb.com/master/vps.conf"
